 ...
 * {@link org.springframework.core.task.TaskExecutor}. This class is also well
 * suited for management and monitoring (e.g. through JMX), providing several
 * useful attributes: "corePoolSize", "maxPoolSize", "keepAliveSeconds" (all
 * supporting updates at runtime); "poolSize", "activeCount" (for introspection
 * only).
 * 
 * <p>
 * For an alternative, you may set up a ThreadPoolExecutor instance directly
 * using constructor injection, or use a factory method definition that points
 * to the JDK 1.5 {@link java.util.concurrent.Executors} class. To expose such a
 * raw Executor as a Spring {@link org.springframework.core.task.TaskExecutor},
 ...
 * 
 * <p>
 * <b>If you prefer native {@link java.util.concurrent.ExecutorService} exposure
 * instead, consider {@link ThreadPoolExecutorFactoryBean} as an alternative to
 * this class.</b>
 * 

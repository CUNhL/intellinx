...
import com.intellinx.us.ps.algorithms.mathematics.Division;
import com.intellinx.us.ps.algorithms.mathematics.Knapsack;
import com.intellinx.us.ps.algorithms.mathematics.Multiplication;
...
public class Mathematics {
	...
	public static void main(String[] args) {
		// MULTIPLICATION
		{
			...
			if (result != check)
				System.out.println("ERROR with a=" + a + " b=" + b + " result="
						+ result + " check=" + check);
			else
